...
export default {
  ...
  methods: {
    ...
    addToCart() {
      ...
      products[this.productId] = this.quantity1;
...
<template>
  <div id="show_detail_area">
    ...
    <div id="details">
      ...
      <hr class="hrr">
      數量：<input id="quantity" v-model="quantity1" type="number">
      <button id="add_cart" type="button" @click="addToCart">加入購物車
        <font-awesome-icon :icon="['fas', 'cart-arrow-down']" size="lg"
                           style="color: #ffffff;"/>
      </button>
